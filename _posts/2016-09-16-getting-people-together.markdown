...
‘Digital transformation’ is a phrase that is used often, sometimes with vaguer meaning than others, and regularly focuses on the technology alone. (Which I [blogged about last week](/my-problem-with-digital-transformation).) While I am at the NHS I want to make sure design is recognised as a thing (and of value), the people involved with design get support and support each other, and the ways of working aren’t missed as part of that. Those are part of what ‘digital transformation’ means to me. And it’s good to talk about them together, regularly.
