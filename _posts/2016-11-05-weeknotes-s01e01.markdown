...
On Wednesday I had the privilege of representing the NHS.UK team at EHI Live in Birmingham, in a session alongside Matthew Parsons from GDS, [Bea Karol Banks](//twitter.com/beatricelucy) from the [Tinder Foundation](//twitter.com/TinderFdn), and Paul Thomas from Microsoft.
